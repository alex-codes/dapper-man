...
namespace DapperMan.SQLite
{
    ...
    {
        private string defaultQueryTemplate = "SELECT * FROM {source} {filter} {sort} LIMIT {pageSize} OFFSET {offset};";
        private string defaultCountQueryTemplate = "SELECT COUNT(*) as [Count] FROM {source} {filter};";
