...
namespace DapperMan.SQLite
{
    ...
    /// </summary>
    public class InsertQuery : SQLiteQueryBase, IInsertQueryBuilder, IGenericQueryGenerator
    {
        private string defaultQyeryTemplate = "INSERT INTO {source} ({fields}) VALUES ({values});";
        private string keyField = null;
        private string[] propNames = null;
        private string scopeIdentityTemplate = "SELECT CAST(last_insert_rowid() as INT);";
